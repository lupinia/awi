...
class page_admin(leaf_admin):
	...
	fieldsets = [
		(None,{'fields':(('title','basename'),'summary','body'),},),
	...
	def view_on_site(self, obj):
		return reverse('page_htm',kwargs={'cached_url':obj.cat.cached_url, 'slug':obj.basename,})
...
class book_admin(admin.ModelAdmin):
	...
	search_fields = ['title', 'slug', 'pages__title', 'pages__basename',]
...
class docfile_admin(admin.ModelAdmin):
	...
	search_fields = ['docfile', 'pages__title', 'pages__basename',]
