...
\copyright {{timestamp|date:'Y'}} by {% include 'includes/authorname.txt' %}, and is free for distribution, but may not be modified or used for monetary gain.  Original version and further downloads available at \url{% templatetag openbrace %}{{source_url}}{% templatetag closebrace %}
