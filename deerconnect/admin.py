...
class link_admin(leaf_admin):
	...
	fieldsets = [
		(None,{'fields':(('label','involved'),'url','desc',),},),
		('Images',{'fields':(('icon','icon_admin_tag',),('icon_large','icon_large_admin_tag','icon_large_type',),)},),
	...
	readonly_fields = ['healthy','icon_admin_tag','icon_large_admin_tag','icon_large_type',] + leaf_admin.readonly_fields
	...
	def icon_large_admin_tag(self, obj):
		return imgfield_as_html(obj, imgfield='icon_large', width='icon_large_width', height='icon_large_height', darkbg=True)
	icon_large_admin_tag.short_description = 'current'
...
class contact_admin(access_admin):
	...
	fieldsets = [
		(None,{'fields':(('label','name','im'),'url','desc','cat'),},),
		('Images',{'fields':(('icon','icon_admin_tag',),('icon_large','icon_large_admin_tag','icon_large_type',),)},),
		('Time Options',{'fields':(('timestamp_post','timestamp_mod',),),},),
	] + access_admin.fieldsets
	list_filter = access_admin.list_filter + ['im',]
	list_display = ('label','icon_admin_tag_list','name','url','cat','im','timestamp_post','timestamp_mod',) + access_admin.list_display
	readonly_fields = ['timestamp_mod','icon_admin_tag','icon_large_admin_tag','icon_large_type',]
