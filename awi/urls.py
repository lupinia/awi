...
urlpatterns = [
	...
	url(r'^accounts/', include([
		...
		url(r'^age_form\.ashx$', never_cache(check_honeypot(field_name=settings.HONEYPOT_FIELD_NAME_AWIACCESS)(access_views.age_verify_full.as_view())), name='age_form'),
		url(r'^age_form_embed\.ashx$', never_cache(check_honeypot(field_name=settings.HONEYPOT_FIELD_NAME_AWIACCESS)(access_views.age_verify.as_view())), name='age_form_embed'),
	])),
