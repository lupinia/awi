...
urlpatterns = [
	...
	url(r'^tools/backgrounds/$', sunset_views.bgtag_list.as_view(), name='sunset_bgtags_all'),
	url(r'^tools/backgrounds/(?P<slug>.*)\.cfm', sunset_views.img_bgtag_view.as_view(), name='sunset_bgtag'),
